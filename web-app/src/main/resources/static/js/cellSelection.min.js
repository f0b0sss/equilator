 ...
 */
;(function (c) {
    var d = {selectClass: "jq-cell-selected", ignoreCell: ""}, l = {
        init: function (a) {
            d = c.extend(d, a);
            ...
            single: function (a) {
                ...
                var b = c(a).closest("table"), f = b.data("last-selected"), e, g;
        ...
        getArray: function (a) {
            var b = ["text",
                "html", "data"], f = a && -1 !== b.indexOf(a) ? a : "text", e = [];
    ...
    c.fn.cellSelection = function (a) {
        if (k[a]) return k[a].apply(this, [].slice.call(arguments,
            1));
        if ("object" !== typeof a && a) c.error('\u041c\u0435\u0442\u043e\u0434 \u0441 \u0438\u043c\u0435\u043d\u0435\u043c "' + a + '" \u043d\u0435 \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u0435\u0442!'); else return l.init.apply(this, arguments)
    }
})(jQuery);